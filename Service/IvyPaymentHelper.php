...
class IvyPaymentHelper
{
    ...
    const LIVE_URL= 'https://api.stage.getivy.de/api/service/';
    const TEST_URL= 'https://api.sand.getivy.de/api/service/';
    const LIVE_BANNER = 'https://cdn.stage.getivy.de/banner.js';
    const TEST_BANNER = 'https://cdn.sand.getivy.de/banner.js';
    const LIVE_BUTTON = 'https://cdn.stage.getivy.de/button.js';
